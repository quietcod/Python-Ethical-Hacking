    ...
    def get_default_config(self):
        ...
        return {
            ...
            "osint": {
                ...
                "shodan_api_key": "ag5h6QGVGLlJv9qQusw0Zy8jKlQu1r7h",
                "virustotal_api_key": "",
                "timeout": 240
            },
            "screenshots": {
...
<body>
    ...
    def _get_interactive_dashboard_css(self):
        ...
        .risk-critical { border-color: #dc3545; color: #dc3545; background: linear-gradient(135deg, #ff416c, #ff4757); color: white; }
        .risk-high { border-color: #fd7e14; color: #fd7e14; background: linear-gradient(135deg, #ffa726, #ff9800); color: white; }
        .risk-medium { border-color: #ffc107; color: #ffc107; background: linear-gradient(135deg, #ffee58, #fdd835); color: #333; }
        .risk-low { border-color: #20c997; color: #20c997; background: linear-gradient(135deg, #4caf50, #2e7d32); color: white; }
        .risk-minimal { border-color: #28a745; color: #28a745; background: linear-gradient(135deg, #66bb6a, #388e3c); color: white; }
        
        .risk-score { font-size: 2.5rem; font-weight: bold; text-shadow: 2px 2px 4px rgba(0,0,0,0.3); }
        .risk-label { font-size: 0.9rem; font-weight: bold; letter-spacing: 1px; }
...
class ReconWrapper:
    ...
    def run_security_analysis(self):
        ...
        # Run comprehensive security scan including SSL/TLS, CT logs, etc.
        ...
        if self.results.get('subdomains'):
            ...
            print(f"🔍 Analyzing security for {len(subdomains_to_scan)} subdomains...")
            ...
            for subdomain in subdomains_to_scan:
                try:
                    ...
                    self.logger.warning(f"Security scan failed for {subdomain}: {e}")
    ...
    def run_osint_collection(self):
        ...
        print("✅ OSINT collection completed")
    ...
    def run_screenshot_capture(self):
        ...
        # Screenshot main target and subdomains
    ...
    def run_light_scan(self):
        ...
        print("🚀 Running light reconnaissance scan...")
    ...
    def run_full_scan(self):
        ...
        print("🚀 Running full reconnaissance scan...")
        ...
        if enable_staggering:
            print("⚡ Performance safeguards enabled - modules will be staggered")
            if light_mode:
